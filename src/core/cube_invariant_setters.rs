...
impl CubieCube {
    pub fn set_twist(&mut self, twist: u16) {
        set_from_number_representation::<CornerOrientation, { CornerPosition::COUNT }, 3>(
            &mut self.corner_orientations,
            twist as usize,
        )
    }

    pub fn set_flip(&mut self, flip: u16) {
        set_from_number_representation::<EdgeOrientation, { EdgePosition::COUNT }, 2>(
            &mut self.edge_orientations,
            flip as usize,
        )
    }
